...
class ChildTreeImageCard extends StatefulWidget {
  final String imgId;
  ...
  @override
  State<ChildTreeImageCard> createState() => _ChildTreeImageCardState();
}

class _ChildTreeImageCardState extends State<ChildTreeImageCard> {
              ...
              children: [
                IconButton(
                  onPressed: () {
                    ...
                    print(controller.childImgList.value);
                  },
                  icon: const Icon(
